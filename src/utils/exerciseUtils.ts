 ...
 * Only exercises explicitly configured with seconds in the program are timed.
 * Do not infer from name/weight — bodyweight rep exercises also have weight_kg 0.
 */
export function isTimeBasedExercise(exercise: {
  ...
  return exercise.seconds !== null && exercise.seconds !== undefined && exercise.seconds > 0;
}
