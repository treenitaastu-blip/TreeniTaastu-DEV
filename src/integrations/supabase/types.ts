  ...
  public: {
    Tables: {
      ...
      client_item_set_weights: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_item_set_weights_client_item_id_fkey"
      ...
      template_alternatives: {
        ...
        Relationships: [
          {
            foreignKeyName: "template_alternatives_primary_exercise_id_fkey"
            columns: ["primary_exercise_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      analyze_exercise_progression_simple_v2: {
        Args: { p_client_item_id: string }
        Returns: Json
      }
      apply_volume_progression: {
        Args: {
          p_energy_level: string
          p_fatigue_level: number
      ...
      auto_progress_program_simple: {
        Args: { p_program_id: string }
        Returns: Json
      }
      check_exercise_weight_stagnation: {
