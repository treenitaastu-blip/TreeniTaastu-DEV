-- Rep-based exercises were sent with seconds=NULL and weight_kg=NULL, which
-- violates template_items_seconds_weight_xor_chk / client_items_seconds_weight_xor_chk.
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- Exactly one of seconds or weight_kg must be set (DB XOR check).
